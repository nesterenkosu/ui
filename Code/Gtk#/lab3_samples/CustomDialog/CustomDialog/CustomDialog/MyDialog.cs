...
namespace CustomDialog
{
	public partial class MyDialog : Gtk.Dialog
	{
		...
		public MyDialog (string myproperty)
		{
			//Конструктор с параметрами - если нужно редактиовать
			//существующие данные.
			//Принимает значения, которые нужно отредактировать.
			this.Build ();
			entry1.Text = myproperty;
			mypropertydata = myproperty;
		}
